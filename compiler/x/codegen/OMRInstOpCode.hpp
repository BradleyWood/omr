      ...
      switch (vl)
         ...
         case TR::VectorLength128:
            if (flags & X86FeatureProp_EVEX128Supported)
               ...
               if (supported && flags & X86FeatureProp_EVEX128RequiresAVX512VBMI2)
                  supported = target->supportsFeature(OMR_FEATURE_X86_AVX512_VBMI2);
               if (supported && flags & X86FeatureProp_EVEX128RequiresAVX512BITALG)
                  supported = target->supportsFeature(OMR_FEATURE_X86_AVX512_BITALG);
               if (supported && flags & X86FeatureProp_EVEX128RequiresAVX512VPOPCNTDQ)
            ...
            if (flags & X86FeatureProp_VEX128Supported)
               ...
               if (supported && flags & X86FeatureProp_VEX128RequiresFMA)
         ...
         case TR::VectorLength256:
            if (flags & X86FeatureProp_EVEX256Supported)
               ...
               if (supported && flags & X86FeatureProp_EVEX256RequiresAVX512CD)
                  supported = target->supportsFeature(OMR_FEATURE_X86_AVX512CD);
               if (supported && flags & X86FeatureProp_EVEX256RequiresAVX512VBMI2)
                  supported = target->supportsFeature(OMR_FEATURE_X86_AVX512_VBMI2);
               if (supported && flags & X86FeatureProp_EVEX256RequiresAVX512BITALG)
                  supported = target->supportsFeature(OMR_FEATURE_X86_AVX512_BITALG);
               if (supported && flags & X86FeatureProp_EVEX256RequiresAVX512VPOPCNTDQ)
                  supported = target->supportsFeature(OMR_FEATURE_X86_AVX512_VPOPCNTDQ);
         ...
         case TR::VectorLength512:
            ...
            if (supported && flags & X86FeatureProp_EVEX512RequiresAVX512CD)
               supported = target->supportsFeature(OMR_FEATURE_X86_AVX512CD);
            if (supported && flags & X86FeatureProp_EVEX512RequiresAVX512VBMI2)
               supported = target->supportsFeature(OMR_FEATURE_X86_AVX512_VBMI2);
            if (supported && flags & X86FeatureProp_EVEX512RequiresAVX512BITALG)
               supported = target->supportsFeature(OMR_FEATURE_X86_AVX512_BITALG);
            if (supported && flags & X86FeatureProp_EVEX512RequiresAVX512VPOPCNTDQ)
               supported = target->supportsFeature(OMR_FEATURE_X86_AVX512_VPOPCNTDQ);
