...
generateRegMaskRegRegInstruction(TR::InstOpCode::Mnemonic op,
   ...
   return new (cg->trHeapMemory()) TR::X86RegMaskRegRegInstruction(reg1, mreg, reg2, reg3, node, op, cg, encoding);
   }
...
generateRegMaskRegInstruction(TR::InstOpCode::Mnemonic op,
   ...
   return new (cg->trHeapMemory()) TR::X86RegMaskRegInstruction(reg1, mreg, reg2, node, op, cg, encoding);
   }
...
generateRegMaskRegInstruction(TR::InstOpCode::Mnemonic op,
   ...
   return new (cg->trHeapMemory()) TR::X86RegMaskRegInstruction(reg1, mreg, reg2, node, op, deps, cg, encoding);
   }
...
generateRegMaskMemInstruction(TR::InstOpCode::Mnemonic op,
   ...
   return new (cg->trHeapMemory()) TR::X86RegMaskMemInstruction(op, node, reg1, mreg, mr, cg, encoding);
   }
...
generateRegMaskMemInstruction(TR::InstOpCode::Mnemonic op,
   ...
   return new (cg->trHeapMemory()) TR::X86RegMaskMemInstruction(op, node, reg1, mreg, mr, deps, cg, encoding);
   }
...
generateMemMaskRegInstruction(TR::InstOpCode::Mnemonic op,
                              ...
                              OMR::X86::Encoding encoding)
   {
   return new (cg->trHeapMemory()) TR::X86MemMaskRegInstruction(op, node, mr, mreg, sreg, cg, encoding);
   }
...
generateMemMaskRegInstruction(TR::InstOpCode::Mnemonic op,
                              ...
                              OMR::X86::Encoding encoding)
   {
   return new (cg->trHeapMemory()) TR::X86MemMaskRegInstruction(op, node, mr, mreg, sreg, cond, cg, encoding);
   }
