...
template <typename TBuffer> typename TBuffer::cursor_t OMR::X86::InstOpCode::OpCode_t::encode(typename TBuffer::cursor_t cursor, uint8_t rexbits, OMR::X86::Encoding encoding) const
   {
   uint32_t enc = encoding == OMR::X86::Default ? vex_l : encoding;
