...
#define INSTRUCTION(name, mnemonic, binary, ...) GET_MACRO(__VA_ARGS__, INSTRUCTION_4, INSTRUCTION_3, INSTRUCTION_2, INSTRUCTION_1, INSTRUCTION_0)(name, mnemonic, binary, __VA_ARGS__) + 0
