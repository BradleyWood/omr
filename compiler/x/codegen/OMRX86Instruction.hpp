...
class X86RegMaskRegInstruction : public TR::X86RegRegInstruction
   ...
   X86RegMaskRegInstruction(TR::Register *treg,
                               ...
                               TR::CodeGenerator *cg,
                               OMR::X86::Encoding encoding = OMR::X86::Default)
      : TR::X86RegRegInstruction(srreg, treg, node, op, cg, encoding), _maskRegister(mreg)
      {
      useRegister(mreg);
      }
   ...
   X86RegMaskRegInstruction(TR::Register *treg,
                               ...
                               TR::CodeGenerator *cg,
                               OMR::X86::Encoding encoding = OMR::X86::Default)
   : TR::X86RegRegInstruction(cond, srreg, treg, node, op, cg, encoding), _maskRegister(mreg)
      {
      useRegister(mreg);
      }
...
class X86RegMaskRegRegInstruction : public TR::X86RegRegRegInstruction
   ...
   X86RegMaskRegRegInstruction(TR::Register *treg,
                               ...
                               TR::CodeGenerator *cg,
                               OMR::X86::Encoding encoding = OMR::X86::Default)
      : TR::X86RegRegRegInstruction(srreg, slreg, treg, node, op, cg, encoding), _maskRegister(mreg)
      {
      useRegister(mreg);
      }
   ...
   X86RegMaskRegRegInstruction(TR::Register *treg,
                               ...
                               TR::CodeGenerator *cg,
                               OMR::X86::Encoding encoding = OMR::X86::Default)
   : TR::X86RegRegRegInstruction(cond, srreg, slreg, treg, node, op, cg, encoding), _maskRegister(mreg)
      {
      useRegister(mreg);
      }
...
class X86MemMaskRegInstruction : public TR::X86MemRegInstruction
   ...
   X86MemMaskRegInstruction(TR::InstOpCode::Mnemonic op,
                            ...
                            TR::CodeGenerator *cg,
                            OMR::X86::Encoding encoding = OMR::X86::Default)
      : X86MemRegInstruction(op, node, mr, sreg, cg, encoding), _maskRegister(mreg)
      {
      useRegister(mreg);
      }
   ...
   X86MemMaskRegInstruction(TR::InstOpCode::Mnemonic op,
                            ...
                            TR::CodeGenerator *cg,
                            OMR::X86::Encoding encoding = OMR::X86::Default)
      : X86MemRegInstruction(op, node, mr, sreg, cond, cg, encoding), _maskRegister(mreg)
      {
      useRegister(mreg);
      }
...
class X86RegMaskMemInstruction : public TR::X86RegMemInstruction
   ...
   X86RegMaskMemInstruction(TR::InstOpCode::Mnemonic op,
                           ...
                           TR::CodeGenerator   *cg,
                           OMR::X86::Encoding encoding = OMR::X86::Default)
   : TR::X86RegMemInstruction(op, node, treg, mr, cg, encoding), _maskRegister(mreg)
      {
      useRegister(mreg);
      }
   ...
   X86RegMaskMemInstruction(TR::InstOpCode::Mnemonic op,
                           ...
                           TR::CodeGenerator *cg,
                           OMR::X86::Encoding encoding = OMR::X86::Default)
   : TR::X86RegMemInstruction(op, node, treg, mr, cond, cg, encoding), _maskRegister(mreg)
      {
      useRegister(mreg);
      }
...
TR::X86RegMaskRegRegInstruction  * generateRegMaskRegRegInstruction(TR::InstOpCode::Mnemonic op, TR::Node *, TR::Register * reg1, TR::Register * mreg, TR::Register * reg2, TR::Register * reg3, TR::CodeGenerator *cg, OMR::X86::Encoding encoding = OMR::X86::Default);
TR::X86RegMaskRegRegInstruction  * generateRegMaskRegRegInstruction(TR::InstOpCode::Mnemonic op, TR::Node *, TR::Register * reg1, TR::Register * mreg, TR::Register * reg2, TR::Register * reg3, TR::RegisterDependencyConditions *deps, TR::CodeGenerator *cg, OMR::X86::Encoding encoding = OMR::X86::Default);

TR::X86RegMaskRegInstruction  * generateRegMaskRegInstruction(TR::InstOpCode::Mnemonic op, TR::Node *, TR::Register * reg1, TR::Register * mreg, TR::Register * reg2, TR::CodeGenerator *cg, OMR::X86::Encoding encoding = OMR::X86::Default);
TR::X86RegMaskRegInstruction  * generateRegMaskRegInstruction(TR::InstOpCode::Mnemonic op, TR::Node *, TR::Register * reg1, TR::Register * mreg, TR::Register * reg2, TR::RegisterDependencyConditions *deps, TR::CodeGenerator *cg, OMR::X86::Encoding encoding = OMR::X86::Default);

TR::X86RegMaskMemInstruction  * generateRegMaskMemInstruction(TR::InstOpCode::Mnemonic op, TR::Node *, TR::Register * reg1, TR::Register * mreg, TR::MemoryReference * mr, TR::CodeGenerator *cg, OMR::X86::Encoding encoding = OMR::X86::Default);
TR::X86RegMaskMemInstruction  * generateRegMaskMemInstruction(TR::InstOpCode::Mnemonic op, TR::Node *, TR::Register * reg1, TR::Register * mreg, TR::MemoryReference * mr, TR::RegisterDependencyConditions *deps, TR::CodeGenerator *cg, OMR::X86::Encoding encoding = OMR::X86::Default);

TR::X86MemMaskRegInstruction  * generateMemMaskRegInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::MemoryReference  *mr, TR::Register * mreg, TR::Register *sreg, TR::CodeGenerator *cg, OMR::X86::Encoding encoding = OMR::X86::Default);
TR::X86MemMaskRegInstruction  * generateMemMaskRegInstruction(TR::InstOpCode::Mnemonic op, TR::Node *node, TR::MemoryReference  *mr, TR::Register * mreg, TR::Register *reg1, TR::RegisterDependencyConditions  *deps, TR::CodeGenerator *cg, OMR::X86::Encoding encoding = OMR::X86::Default);
